...
<template>
  <div class="relative">
    <textarea class="w-full shadow-inner-input h-48 p-3 border border-gray-300 focus:ring-brand-500 focus:border-brand-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              name="secret"
              autofocus
              autocomplete="off"
